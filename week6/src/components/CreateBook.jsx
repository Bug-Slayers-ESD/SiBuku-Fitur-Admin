...
const CreateBook = ({ baseUrl }) => {
  ...
  function handleSubmit(e) {
    ...
    fetch(`https://${baseUrl}/books`, { method: "POST", body: formData })
      .then((res) => {
        if (!res.ok) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <form id="createForm" onSubmit={handleSubmit} className="flex flex-col gap-3 my-3">
          <input
            name="image"
            type="file"
        ...
        <div className="flex justify-end gap-x-3">
          ...
          <button form="createForm" type="submit" className="flex p-2 bg-blue-500 text-white rounded">
